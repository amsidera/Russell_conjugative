		function mytoggle2(element,top){
			...
			for (i = 0; i < dropdowns.length-1; i++) {
				  ...
				  x += '/' + openDropdown.innerHTML;
			  }
			 x += ')';
			if (dropdowns[dropdowns.length-1].innerHTML == 'All'){
				var word_old = button[0].innerHTML;
		...
		function iitbutton(elem) {var x = 'text' + elem; document.getElementById(x).classList.toggle("show");}
